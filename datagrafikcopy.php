...
t1 = performance.now();
var tee1 = (t1 - t0);
console.log("Waktu Proses database di datagrafikcopy.php " + (t1 - t0) + " milliseconds.");
</script>


<canvas id=myChartcopy width="300" height="100" style="margin-left: -4%"></canvas>
  <div class="content">
    <div class="row">
...
<script>
  var canvas = document.getElementById('myChartcopy');
        var data = {
